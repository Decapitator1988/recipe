package com.decapitator.recipe.bootstrap;

import com.decapitator.recipe.domain.*;
import com.decapitator.recipe.repostitories.CategoryRepository;
import com.decapitator.recipe.repostitories.RecipeRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        if (!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM bot found");
        }
        ...
        UnitOfMeasure teaSpuunUom = teaSpoonUomOptional.get();
        UnitOfMeasure dashUom = dashUomOptional.get();
        UnitOfMeasure pintUom = pintUomOptional.get();
        UnitOfMeasure caupsUom = cupsUomOptional.get();
        ...
        guacRecipe.addIngredient(new Ingredient("Kosher salt", new BigDecimal(".5"), teaSpuunUom));
        guacRecipe.addIngredient(new Ingredient("fresh lime juice ot fresh lemon juice", new BigDecimal(2), tableSpoonUom));
